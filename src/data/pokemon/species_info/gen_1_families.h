...
#define CHARIZARD_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 85 : 85)
...
#define PIKACHU_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 50 : 30)
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 55 : 40)
